...
export default function Couple(){
    return (
        <div className="h-[1050px] w-full sm:w-[540px] relative xl:w-4/12  z-10 rounded-xl -mt-2 flex flex-col items-center opacity-85" id='couple'>
          ...
          <p className='font-qamila z-10 text-3xl text-[#d106b2] mt-4 sm:mt-7'>&</p>
          ...
          <p className='font-serif z-10 drop-shadow-lg shadow-pink-500 text-sm px-16 text-center mt-2 sm:mt-5'>Putri Pertama dari Bpk. Aruman (Alm)</p>
          <p className='font-serif z-10 drop-shadow-lg shadow-pink-500 text-sm px-20 text-center'>& Ibu Arnasih</p>
