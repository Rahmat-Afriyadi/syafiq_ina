...
export default function Couple(){
    return (
        <div className="h-[1050px] w-full sm:w-[540px] relative xl:w-4/12  z-10 rounded-xl -mt-2 flex flex-col items-center opacity-85" id='couple'>
          <br></br><br></br><br></br>
          <p className='font-monsieur z-10 mt-24 sm:mt-16 md:mt-16 lg:mt-[70px] text-3xl text-[#048bc9]'>Assalamualaikum Wr. Wb</p>
          ...
          <p className='font-qamila z-10 drop-shadow-lg shadow-pink-500 text-2xl font-medium text-[#c904c0] -mt-3 sm:mt-2'>Abu Syafiq Arridho S.M</p>
          ...
          <p className='font-monsieur font-extrabold z-10 text-3xl text-[#c904c0] mt-4 sm:mt-7'>&</p>
          <div className="sm:mt-5">
            <Image className='z-10 scale-75 sm:scale-100' width={180} height={180} src="/images/clipina.png" alt='couple'/>
          </div>
          <p className='font-qamila z-10 drop-shadow-lg shadow-pink-500 text-2xl font-medium text-[#c904c0] -mt-3 sm:mt-2'>Ina Amanda</p>
